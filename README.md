...
## página web de la red colombiana de foto trampeo.

Made with hugo-creative-theme in R studio
https://github.com/digitalcraftsman/hugo-creative-theme
Code deployment in GitHub as config.yml and site rendered (with hugo). Later and published by https://www.netlify.com/

Final web page at:
[https://redfototrampeo.netlify.app/](https://redfototrampeo.netlify.app/)
